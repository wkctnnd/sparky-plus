...
namespace sparky
{
	namespace render
	{
		void  GameRenderer2::AddRenderable(Renderable* r)
		{

		}

		void GameRenderer2::PostUpdate()
		{
			PhotoObjects.clear();
		...
		GameRenderer2::GameRenderer2(world::Scene* scene)
		{
			m_Scene = scene;
		}
		void GameRenderer2::Initialize()
		{
		...
		void GameRenderer2::RenderScene(float3 position, float3 axis, float angle)
		{
		...
		void GameRenderer2::RenderScene(sparky::maths::mat4 viewmatrix)
		{
